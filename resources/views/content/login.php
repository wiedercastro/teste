...
<body class="hold-transition login-page">
	...
	<div class="login-box">
		...
		<div class="login-box-body">
			...
			<a href="<?php echo PL_PATH_ADMIN; ?>/recuperar_senha">Esqueci a senha!</a><br>
			<a href="<?php echo PL_PATH_ADMIN; ?>/cadastrar_loja" class="text-center">Realizar um novo cadastro!</a>
